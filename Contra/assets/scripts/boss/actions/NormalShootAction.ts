...
export class NormalShootAction implements IBossAction {
    readonly name = 'normalShoot';
    ...
    update(ctx: IBossActionContext, _dt: number): void {
        ...
        const count = Math.round(GameConfig.boss.normalFanCount * this._bulletCountMult);
        ...
        BulletFactory.spawnFan(
            ...
            GameConfig.boss.normalFanSpread, count,
        );
